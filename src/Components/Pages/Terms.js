    ...
    <div>
      ...
      >
        ...
        <p style={{ fontSize: "15px" }}>
          This website is operated by Creare INC.. Throughout the site, the
          terms “we”, “us” and “our” refer to Creare Inc. Creare Inc. offers
        ...
        <p style={{ fontSize: "15px" }}>
          ...
          <br />
          YYou agree to provide current, complete and accurate purchase and
        ...
        <p style={{ fontSize: "15px" }}>
          ...
          contain libellous or otherwise unlawful, abusive or obscene material,
        ...
        <p style={{ fontSize: "15px" }}>
          ...
          <br />
          <br />
          In no case shall Creare Inc., our directors, officers, employees,
        ...
        <p style={{ fontSize: "15px" }}>
          You agree to indemnify, defend and hold harmless Creare Inc. and our
        ...
        <p style={{ fontSize: "15px" }}>
          ...
          <br />
          <br />
          If in our sole judgement you fail, or we suspect that you have failed,
